...
import type { ApiResponseLoginResponse, DevLoginRequest } from "../pickcaAPI.schemas";
 ...
 */
export const devLogin = (devLoginRequest: DevLoginRequest, signal?: AbortSignal) => {
...
export const getDevLoginMutationOptions = <TError = unknown, TContext = unknown>(options?: {
